 ...
 def tick(self,dt):
  try:
   ...
   if self.i==len(self.steps):
    ...
    Path('D:/CodexUE55Lab/als-reversals.json').write_text(json.dumps(self.rows,indent=2));unreal.unregister_slate_post_tick_callback(self.handle);print('REVERSALS DONE');return
