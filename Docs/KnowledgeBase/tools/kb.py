...
PURPOSE = {
    ...
    'HodgeGroundedLocomotion': 'CodexText 实验：在 ALS 基础动画上增加平地起停/转身/脚锁，并扩展上半身 Overlay、左手握持、步幅与地形 IK。',
    'HodgeGroundedAuthoring': 'CodexText 实验：编辑器辅助库，含 Grounded 图层与停步/转身精修、步幅、地形、战斗图层等编辑期构建函数。',
