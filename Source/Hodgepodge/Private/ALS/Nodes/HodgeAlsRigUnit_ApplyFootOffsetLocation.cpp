#include "ALS/Nodes/HodgeAlsRigUnit_ApplyFootOffsetLocation.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(HodgeAlsRigUnit_ApplyFootOffsetLocation)

void FHodgeAlsRigUnit_ApplyFootOffsetLocation::Initialize()
{
	bInitialized = false;
}

FHodgeAlsRigUnit_ApplyFootOffsetLocation_Execute()
{
	...
	{
		OffsetLocationZ = UHodgeAlsMath::SpringDampFloat(OffsetSpringState, OffsetLocationZ, TargetOffsetLocationZ,
