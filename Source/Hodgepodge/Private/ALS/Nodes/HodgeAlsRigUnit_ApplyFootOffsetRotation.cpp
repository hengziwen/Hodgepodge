#include "ALS/Nodes/HodgeAlsRigUnit_ApplyFootOffsetRotation.h"

#include "Engine/HitResult.h"
#include "ALS/Utility/HodgeAlsMath.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(HodgeAlsRigUnit_ApplyFootOffsetRotation)

void FHodgeAlsRigUnit_ApplyFootOffsetRotation::Initialize()
{
	bInitialized = false;
}

FHodgeAlsRigUnit_ApplyFootOffsetRotation_Execute()
{
	...
	OffsetNormal = UHodgeAlsMath::ExponentialDecay(OffsetNormal, FootOffsetNormal,
