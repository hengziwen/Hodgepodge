...
#include UE_INLINE_GENERATED_CPP_BY_NAME(HodgeAlsDebugUtility)

bool UHodgeAlsDebugUtility::ShouldDisplayDebugForActor(const AActor* Actor, const FName& DisplayName)
{
...
void UHodgeAlsDebugUtility::DrawHalfCircle(const UObject* WorldContext, const FVector& Location, const FVector& XAxis,
                                      ...
                                      const float Duration, const float Thickness, const uint8 DepthPriority)
{
	...
	if (!HODGEALS_ENSURE(IsValid(World)))
	{
		return;
	}
...
void UHodgeAlsDebugUtility::DrawQuarterCircle(const UObject* WorldContext, const FVector& Location, const FVector& XAxis,
                                         const FVector& YAxis, const float Radius, const FLinearColor& Color,
                                         const float Duration, const float Thickness, const uint8 DepthPriority)
{
#if ENABLE_DRAW_DEBUG
...
void UHodgeAlsDebugUtility::DrawSphereAlternative(const UObject* WorldContext, const FVector& Location, const FRotator& Rotation,
...
void UHodgeAlsDebugUtility::DrawLineTraceSingle(const UObject* WorldContext, const FVector& Start, const FVector& End, const bool bHit,
...
void UHodgeAlsDebugUtility::DrawSweepSphere(const UObject* WorldContext, const FVector& Start, const FVector& End, const float Radius,
...
void UHodgeAlsDebugUtility::DrawSweepSingleSphere(const UObject* WorldContext, const FVector& Start, const FVector& End,
...
void UHodgeAlsDebugUtility::DrawSweepSingleCapsule(const UObject* WorldContext, const FVector& Start, const FVector& End,
...
void UHodgeAlsDebugUtility::DrawSweepSingleCapsuleAlternative(const UObject* WorldContext, const FVector& Start, const FVector& End,
