...
#include "HodgeAlsMantlingSettings.generated.h"

class UAnimMontage;
class UCurveFloat;

UENUM(BlueprintType)
enum class EHodgeAlsMantlingType : uint8
{
	High,
	Low,
	InAir
...
struct HODGEPODGE_API FHodgeAlsMantlingParameters
{
	GENERATED_BODY()
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "HODGEALS", Meta = (ForceUnits = "cm"))
	float MantlingHeight{0.0f};

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "HODGEALS")
	EHodgeAlsMantlingType MantlingType{EHodgeAlsMantlingType::High};
};

UCLASS(Blueprintable, BlueprintType)
class HODGEPODGE_API UHodgeAlsMantlingSettings : public UDataAsset
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct HODGEPODGE_API FHodgeAlsMantlingTraceSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct HODGEPODGE_API FHodgeAlsGeneralMantlingSettings
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "HODGEALS", Meta = (ClampMin = 0, ClampMax = 90, ForceUnits = "deg"))
	float SlopeAngleThreshold{35.0f};

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "HODGEALS", AdvancedDisplay, Meta = (ClampMin = 0, ClampMax = 1))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "HODGEALS")
	FHodgeAlsMantlingTraceSettings GroundedTrace;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "HODGEALS")
	FHodgeAlsMantlingTraceSettings InAirTrace{{50.0f, 150.0f}, 70.0f};
