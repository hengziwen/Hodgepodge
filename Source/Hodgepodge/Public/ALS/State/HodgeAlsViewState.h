...
#include "HodgeAlsViewState.generated.h"

USTRUCT(BlueprintType)
struct HODGEPODGE_API FHodgeAlsViewNetworkSmoothingState
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct HODGEPODGE_API FHodgeAlsViewState
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "HODGEALS")
	FHodgeAlsViewNetworkSmoothingState NetworkSmoothing;
