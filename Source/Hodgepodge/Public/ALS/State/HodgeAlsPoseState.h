...
#include "HodgeAlsPoseState.generated.h"

USTRUCT(BlueprintType)
struct HODGEPODGE_API FHodgeAlsPoseState
{
	GENERATED_BODY()
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "HODGEALS", Meta = (ClampMin = 0, ClampMax = 3))
