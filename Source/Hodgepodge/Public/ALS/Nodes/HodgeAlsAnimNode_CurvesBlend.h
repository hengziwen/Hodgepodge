...
#include "HodgeAlsAnimNode_CurvesBlend.generated.h"

UENUM(BlueprintType)
enum class EHodgeAlsCurvesBlendMode : uint8
{
...
struct HODGEPODGE_API FHodgeAlsAnimNode_CurvesBlend : public FAnimNode_Base
{
	GENERATED_BODY()
...
public:
	...
	EHodgeAlsCurvesBlendMode BlendMode{EHodgeAlsCurvesBlendMode::BlendByAmount};
#endif
...
public:
	...
	EHodgeAlsCurvesBlendMode GetBlendMode() const;
};
