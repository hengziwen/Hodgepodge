...
#include "HodgeAlsRigUnit_ApplyFootOffsetLocation.generated.h"

USTRUCT(DisplayName = "Apply Foot Offset Location", Meta = (Category = "HODGEALS", NodeColor = "0.0 0.36 1.0"))
struct HODGEPODGE_API FHodgeAlsRigUnit_ApplyFootOffsetLocation : public FRigUnitMutable
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(Transient)
	FHodgeAlsSpringFloatState OffsetSpringState;
