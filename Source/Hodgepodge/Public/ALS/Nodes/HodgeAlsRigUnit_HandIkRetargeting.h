...
#include "HodgeAlsRigUnit_HandIkRetargeting.generated.h"

USTRUCT(DisplayName = "Hand Ik Retargeting", Meta = (Category = "HODGEALS", NodeColor = "0.0 0.36 1.0"))
struct HODGEPODGE_API FHodgeAlsRigUnit_HandIkRetargeting : public FRigUnitMutable
{
	GENERATED_BODY()
