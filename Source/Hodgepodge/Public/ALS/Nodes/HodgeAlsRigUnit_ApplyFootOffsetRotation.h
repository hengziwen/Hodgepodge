...
#include "HodgeAlsRigUnit_ApplyFootOffsetRotation.generated.h"

USTRUCT(DisplayName = "Apply Foot Offset Rotation", Meta = (Category = "HODGEALS", NodeColor = "0.0 0.36 1.0"))
struct HODGEPODGE_API FHodgeAlsRigUnit_ApplyFootOffsetRotation : public FRigUnitMutable
{
	GENERATED_BODY()
