...
#include "HodgeAlsRigUnit_FootOffsetTrace.generated.h"

USTRUCT(DisplayName = "Foot Offset Trace", Meta = (Category = "HODGEALS", NodeColor = "0.2 0.4 1.0"))
struct HODGEPODGE_API FHodgeAlsRigUnit_FootOffsetTrace : public FRigUnit
{
	GENERATED_BODY()
