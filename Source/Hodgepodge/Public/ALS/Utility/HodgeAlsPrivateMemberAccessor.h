...
namespace HodgeAlsPrivateMemberAccessor
{
...
#define HODGEALS_DEFINE_PRIVATE_MEMBER_ACCESSOR(AccessorName, MemberPointer, ...) \
	struct AccessorName \
	{ \
		...
		{ \
			return HodgeAlsPrivateMemberAccessor::Access<AccessorName>(Forward<ThisType>(This), Forward<ArgumentsType>(Arguments)...); \
		} \
	}; \
	\
	template struct HodgeAlsPrivateMemberAccessor::TPointerInitializer<AccessorName, MemberPointer>; \
