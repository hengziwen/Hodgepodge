...
#include "HodgeAlsDebugUtility.generated.h"

UCLASS()
class HODGEPODGE_API UHodgeAlsDebugUtility : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	UFUNCTION(BlueprintPure, Category = "HODGEALS|Debug Utility",
	...
	UFUNCTION(BlueprintCallable, Category = "HODGEALS|Debug Utility",
